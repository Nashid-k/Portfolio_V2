...
const CustomCursor = () => {
  ...
  return (
    <>
      {/* Main cursor dot - simplified */}
      <div 
        className="fixed w-3 h-3 bg-indigo-500 rounded-full pointer-events-none z-[9999] mix-blend-difference transition-transform duration-100 ease-out"
        style={{
      ...
      {/* Cursor ring - simplified */}
      <div 
        className="fixed w-10 h-10 border-2 border-indigo-500/30 rounded-full pointer-events-none z-[9998] transition-transform duration-200 ease-out"
        style={{
...
export default function Portfolio() {
  ...
  return (
    <div 
      className="min-h-screen bg-gray-50 text-gray-900 selection:bg-indigo-300 selection:text-indigo-900" 
      style={{ cursor: isDesktop ? 'none' : 'auto' }}
    >
      {/* Custom Cursor */}
      <CustomCursor />
      ...
      <div className="fixed inset-0 z-0 opacity-20">
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#d1d5db_1px,transparent_1px),linear-gradient(to_bottom,#d1d5db_1px,transparent_1px)] bg-[size:30px_30px]" />
      </div>

      {/* Navigation */}
      <header className={`fixed top-0 z-50 w-full px-4 py-4 lg:px-10 transition-all duration-300 ${
        scrollY > 100 
          ? 'bg-gray-50/95 backdrop-blur-md shadow-md' 
          : 'bg-transparent'
      }`}>
        <nav className="flex items-center justify-between">
          <motion.div {...fadeInUp}>
            <a
              href="/"
              className="text-base font-sans text-indigo-600 hover:text-indigo-500 transition-colors cursor-pointer"
            >
              Nashid
            </a>
          </motion.div>
          ...
          >
            {[
              ...
              <button
                key={id}
                onClick={() => scrollToSection(id)}
                className="text-sm font-sans text-gray-600 hover:text-indigo-600 transition-colors cursor-pointer"
              >
                {label}
              </button>
            ))}
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="ml-4 px-3 py-1.5 text-sm font-sans text-indigo-600 border border-indigo-600 rounded-md hover:bg-indigo-50 transition-colors cursor-pointer"
            >
              Resume
            </a>
          </motion.div>
          ...
          <button
            onClick={() => setIsMenuOpen(!isMenuOpen)}
            className="lg:hidden p-1.5 text-indigo-600 cursor-pointer"
            aria-label="Toggle menu"
          >
        ...
        <AnimatePresence>
          {isMenuOpen && (
            <motion.div
              ...
              exit={{ opacity: 0, x: '100%' }}
              transition={{ type: 'tween', duration: 0.3 }}
              className="fixed top-0 right-0 bottom-0 z-50 w-3/4 bg-gray-100 lg:hidden"
            >
              <div className="flex flex-col h-full p-4">
                <button
                  onClick={() => setIsMenuOpen(false)}
                  className="self-end p-1.5 text-indigo-600 mb-6 cursor-pointer"
                >
                  <X size={20} />
                </button>
                <nav className="flex flex-col space-y-6 font-sans text-base">
                  {[
                    { id: 'about', label: 'About' },
                    { id: 'experience', label: 'Experience' },
                    { id: 'work', label: 'Work' },
                    ...
                    <button
                      key={id}
                      onClick={() => scrollToSection(id)}
                      className="text-left text-gray-600 hover:text-indigo-600 cursor-pointer"
                    >
                      {label}
                    </button>
                  ))}
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-block w-fit px-3 py-1.5 text-indigo-600 border border-indigo-600 rounded-md hover:bg-indigo-50 cursor-pointer"
                  >
                    Resume
                  </a>
                </nav>
      ...
      <div className="fixed bottom-0 left-4 hidden lg:block z-10">
        <motion.div
          ...
          className="flex flex-col items-center space-y-4 after:content-[''] after:block after:w-px after:h-20 after:bg-gray-300 after:mt-4"
        >
          {[
            { href: "https://github.com/Nashid-k", icon: Github },
            { href: "https://linkedin.com/in/nashid-k-080909273/", icon: Linkedin },
            ...
            <a
              ...
              target={href.startsWith('mailto:') ? undefined : "_blank"}
              rel={href.startsWith('mailto:') ? undefined : "noopener noreferrer"}
              className="text-gray-500 hover:text-indigo-600 hover:translate-y-[-2px] transition-all duration-300 cursor-pointer"
            >
              <Icon size={18} />
            </a>
          ))}
      ...
      <div className="fixed bottom-0 right-4 hidden lg:block z-10">
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 1.2 }}
          className="flex flex-col items-center after:content-[''] after:block after:w-px after:h-20 after:bg-gray-300 after:mt-4"
        >
          <a
            href="mailto:nashidk1999@gmail.com"
            className="font-sans text-xs text-gray-500 hover:text-indigo-600 hover:translate-y-[-2px] transition-all duration-300 cursor-pointer"
            style={{ writingMode: 'vertical-rl' }}
          >
            nashidk1999@gmail.com
          </a>
      ...
      <main className="relative z-10">
        {/* Hero Section */}
        <section className="min-h-screen flex items-center px-4 lg:px-10 max-w-6xl mx-auto">
          <div className="max-w-3xl">
            <motion.p
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.3 }}
              className="font-sans text-indigo-600 mb-4 text-sm lg:text-base"
            >
              Hi, my name is
            </motion.p>
            ...
            <motion.h1
              ...
              className="text-4xl lg:text-6xl font-extrabold text-gray-900 mb-3"
            >
              Nashid.
            </motion.h1>
            ...
            <motion.h2
              ...
              className="text-3xl lg:text-5xl font-extrabold text-gray-600 mb-5"
            >
              I build things for the web.
            </motion.h2>
            ...
            <motion.p
              ...
              className="max-w-xl text-base text-gray-600 mb-10 leading-loose"
            >
              I'm a full-stack developer specializing in building exceptional digital experiences. 
              Currently, I'm focused on creating accessible, user-centered products using modern web technologies 
              and the MERN stack.
            ...
            >
              <button
                onClick={() => scrollToSection('work')}
                className="px-6 py-3 text-indigo-600 border border-indigo-600 rounded-md font-sans hover:bg-indigo-50 transition-colors cursor-pointer"
              >
                Check out my work!
              </button>
            </motion.div>
        ...
        {/* About Section */}
        <section id="about" className="py-20 px-4 lg:px-10 max-w-6xl mx-auto">
          <motion.div
          ...
          >
            <h2 className="flex items-center text-xl lg:text-2xl font-extrabold text-gray-900 mb-6">
              <span className="font-sans text-sm lg:text-base text-indigo-600 mr-3">01.</span>
              About Me
              <div className="ml-3 h-px bg-gray-300 flex-1 max-w-sm"></div>
            </h2>
            ...
            <div className="grid lg:grid-cols-3 gap-10 lg:gap-12">
              <div className="lg:col-span-2 space-y-3">
                ...
                <p className="text-gray-600 mb-5 leading-loose">
                  Here are a few technologies I've been working with recently:
                </p>

                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 gap-1 font-sans text-xs text-gray-600">
                  {[
                    "JavaScript (ES6+)", "TypeScript", "React", "Node.js", "Express", "MongoDB",
                    "PostgreSQL", "Firebase", "AWS (EC2)", "Git & GitHub", "Tailwind CSS", "Bootstrap"
                  ].map((tech) => (
              ...
              <div className="relative">
                <div className="relative max-w-sm mx-auto lg:mx-0">
                  <div className="bg-indigo-200 rounded-md absolute -inset-3 rotate-3"></div>
                  <div className="relative bg-gray-100 rounded-md overflow-hidden shadow-md">
                    <img
                      src="/profile.jpg"
                      alt="Nashid"
                      className="w-full h-auto filter contrast-125 hover:contrast-100 transition-all duration-300"
                    />
                    <div className="absolute inset-0 bg-indigo-200/10 hover:bg-transparent transition-colors duration-300"></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Experience Section */}
        <section id="experience" className="py-20 px-4 lg:px-10 max-w-6xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.7 }}
          >
            <h2 className="flex items-center text-xl lg:text-2xl font-extrabold text-gray-900 mb-10">
              <span className="font-sans text-sm lg:text-base text-indigo-600 mr-3">02.</span>
              Where I've Learned
              <div className="ml-3 h-px bg-gray-300 flex-1 max-w-sm"></div>
            </h2>
            ...
            <div className="max-w-4xl space-y-6">
              {experiences.map((exp, index) => (
                <div key={index} className="border-b border-gray-200 pb-6 last:border-b-0">
                  ...
                  <p className="font-sans text-xs text-gray-500 mb-5">{exp.range}</p>
                  
                  <ul className="space-y-2">
                    {exp.description.map((item, i) => (
                      <li key={i} className="flex text-gray-600 text-sm leading-loose">
        ...
        {/* Featured Projects */}
        <section id="work" className="py-20 px-4 lg:px-10 max-w-6xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.7 }}
          >
            <h2 className="flex items-center text-xl lg:text-2xl font-extrabold text-gray-900 mb-14">
              <span className="font-sans text-sm lg:text-base text-indigo-600 mr-3">03.</span>
              Some Things I've Built
              <div className="ml-3 h-px bg-gray-300 flex-1 max-w-sm"></div>
            </h2>
            ...
            <div className="space-y-12">
              {projects.map((project, index) => (
                <div
                  key={project.id}
                  className="group relative bg-gray-100/50 rounded-md p-6 hover:shadow-md transition-all duration-300"
                >
                  <div className="flex flex-col lg:flex-row lg:items-start gap-6">
                    <div className="flex-shrink-0">
                      <div className="w-16 h-16 bg-gray-200 rounded-md flex items-center justify-center text-indigo-600 group-hover:bg-gray-300 transition-colors duration-300">
                        {project.icon}
                      </div>
                    </div>
                    ...
                    <div className="flex-1">
                      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-3 mb-3">
                        <div>
                          <p className="font-sans text-indigo-600 text-xs mb-1">Featured Project</p>
                      ...
                      <p className="text-gray-600 mb-3 leading-loose text-sm">{project.description}</p>
                      
                      <ul className="flex flex-wrap gap-2 font-sans text-xs text-gray-600">
                        {project.tech.map((tech, i) => (
                          <li key={i} className="bg-gray-200 px-2 py-0.5 rounded-md">{tech}</li>
                        ))}
                      </ul>
                    </div>
                  </div>
        ...
        {/* Other Projects */}
        <section className="py-20 px-4 lg:px-10 max-w-6xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-100px" }}
          ...
          >
            <h2 className="text-2xl font-extrabold text-gray-900 mb-3">Other Noteworthy Projects</h2>
            <a
              href="https://github.com/Nashid-k"
              target="_blank"
              rel="noopener noreferrer"
              className="text-indigo-600 font-sans text-sm hover:underline cursor-pointer"
            >
              view the archive
            </a>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {otherProjects.map((project, index) => (
              <motion.div
                ...
                className="bg-gray-100 p-5 rounded-md hover:shadow-md hover:-translate-y-1 transition-all duration-300"
              >
                ...
                <p className="text-gray-600 text-xs mb-3 leading-loose">{project.description}</p>
                
                <ul className="flex flex-wrap gap-1.5 font-sans text-xs text-gray-600">
                  {project.tech.map((tech, i) => (
                    <li key={i}>{tech}</li>
                  ))}
                </ul>
        ...
        {/* Contact Section */}
        <section id="contact" className="py-20 px-4 lg:px-10 max-w-3xl mx-auto text-center">
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.7 }}
          >
            <p className="font-sans text-indigo-600 mb-3 text-sm">04. What's Next?</p>
            <h2 className="text-3xl lg:text-4xl font-extrabold text-gray-900 mb-5">Get In Touch</h2>
            <p className="text-gray-600 mb-10 text-base leading-loose">
              Although I'm not currently looking for any new opportunities, my inbox is always open. 
              Whether you have a question or just want to say hi, I'll try my best to get back to you!
            </p>
            <a
              href="mailto:nashidk1999@gmail.com"
              className="inline-block px-6 py-3 text-indigo-600 border border-indigo-600 rounded-md font-sans hover:bg-indigo-50 transition-colors cursor-pointer"
            >
              Say Hello
            </a>
          </motion.div>
      ...
      {/* Footer */}
      <footer className="pb-10 px-4 lg:px-10 text-center">
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.7 }}
        >
          <div className="lg:hidden flex justify-center space-x-5 mb-5">
            {[
              { href: "https://github.com/Nashid-k", icon: Github },
              { href: "https://linkedin.com/in/nashid-k", icon: Linkedin },
              { href: "mailto:nashidk1999@gmail.com", icon: Mail }
